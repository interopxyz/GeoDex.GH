...
namespace Geodex.GH.Curves
{
    public class Cyclic : GeodexBase
    {
        ...
        {
            Geodex.Curves.Cyclic.CyclicHarmonic
                Geodex.Curves.Cyclic.Epicycloid
                Geodex.Curves.Cyclic.Epitrochoid
                Geodex.Curves.Cyclic.Hypocycloid_A
                Geodex.Curves.Cyclic.Hypocycloid_B
                Geodex.Curves.Cyclic.Hypotrochoid
                Geodex.Curves.Cyclic.Leaf
                Geodex.Curves.Cyclic.Rhodonea
                Geodex.Curves.Cyclic.Rose
                Geodex.Curves.Cyclic.Superformula
            entries = new string[] { "Epicycloid", "Epitrochoid", "Hypocycloid_A", "Hypocycloid_B", "Hypotrochoid", "BoothsLemniscate", "BoothsOvals", "Cassini", "Circle", "Ellipse", "Folium", "FreethNephroid", "Limacon", "Lissajous", "Plateau", "SuperEllipse", "Teardrop" };
